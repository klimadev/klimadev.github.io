...
<body class="bg-gray-900 text-white font-sans">
    ...
    <section id="main-projects" class="py-16 text-white fade-in shadow-card active">
        <div class="container mx-auto">
            ...
            <!-- Conteúdo dos principais projetos -->
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="p-4 bg-gray-800 rounded-lg shadow-lg">
                    <h3 class="text-xl font-bold mb-2">AUTO DRAWN</h3>
                    <p class="text-lg">Sistema de visão computacional para identificar todos contornos do principal
                        objeto ou ser em uma imagem, e assim desenha-lo ponto por ponto</p>
                    <button class="btn-link mt-4" onclick="openProjectPopup('autodrawn')">Saiba mais</button>
                </div>

                <div class="p-4 bg-gray-800 rounded-lg shadow-lg">
                    <h3 class="text-xl font-bold mb-2">L.A.R.I</h3>
                    <p class="text-lg">Uma assistente virtual construida fortemente inspirada no ficticio JARVIS, o
                        super assistente virtual do personagem da marvel homen de ferro.</p>
                    <button class="btn-link mt-4" onclick="openProjectPopup('lari')">Saiba mais</button>
                </div>

                <div class="p-4 bg-gray-800 rounded-lg shadow-lg">
                    <h3 class="text-xl font-bold mb-2">VSTARS</h3>
                    <p class="text-lg">Uma empresa simulada, criado em um treinamento que fiz de gestão empresarial,
                        porem o projeto que quero mostrar aqui é uma aplicação de FOOD PAGE com tudo que um restaurante
                        precisaria em seu proprio APP</p>
                    <button class="btn-link mt-4" onclick="openProjectPopup('vstars')">Saiba mais</button>
                </div>
                <div class="p-4 bg-gray-800 rounded-lg shadow-lg">
                    <h3 class="text-xl font-bold mb-2">BAÚ DOS PIRATAS</h3>
                    <p class="text-lg">Isso faz parte de um projeto pessoal, de modernizar aplicações antigas, e ver
                        como elas ficaram hoje em dia, escolhe sempre as maiores aplicações da internet, e uma delas foi
                        o ThePirateBay</p>
                    <button class="btn-link mt-4" onclick="openProjectPopup('tpb2')">Saiba mais</button>
                </div>
                <div class="p-4 bg-gray-800 rounded-lg shadow-lg">
                    <h3 class="text-xl font-bold mb-2">LIMA STORE</h3>
                    <p class="text-lg">Bom, é basicamente a minha loja pessoal, porem... ela tem um toque especial, alem
                        de ser bem organizada, e ser feita por min (brincadeira) hehe, o especial dela é sua
                        Inteligencia Artificial</p>
                    <button class="btn-link mt-4" onclick="openProjectPopup('limastore')">Saiba mais</button>
                </div>
                <div class="p-4 bg-gray-800 rounded-lg shadow-lg">
                    <h3 class="text-xl font-bold mb-2">E.A.S.Y. (Effortless All-in-One Payment System)</h3>
                    <p class="text-lg">Conheça o E.A.S.Y. - o Sistema de Pagamento Tudo-em-Um que é mais simples do que
                        fazer pipoca no micro-ondas! Integre qualquer forma de pagamento com facilidade e rapidez seja
                        ela de moedas normais ou stable/crypto moedas. Adeus, complicação! Bem-vindo, facilidade!</p>
                    <button class="btn-link mt-4" onclick="openProjectPopup('e.a.s.y')">Saiba mais</button>
                </div>
            </div>
        </div>
    </section>
    ...
    <script>
        ...
        function openProjectPopup(projectName) {
            // Definir título e descrição do projeto
            var title;
            var description;
            if (projectName === 'autodrawn') {
                title = "AUTO DRAWN";
                description = "Ele pode ser usado em diversos casos, como desenhar a forma em que uma máquina pode ver certa imagem, ser o melhor no Gartic. Basicamente ele usa o cursor para desenhar cada ponto de contorno da imagem.";
                // Adicionar conteúdo ao carrossel
                var carouselContainer = document.getElementById('project-carousel');
                carouselContainer.innerHTML = '';
                var media = [{
                    type: 'video',
                    src: 'images/AutoDrawn/preview.webm'
                }];
            ...
            if (projectName === 'lari') {
                title = "Lima Artificial Retarded Inteligence";
                description = "A LARI demonstra capacidade para desempenhar uma variedade de tarefas úteis, incluindo a reprodução de séries de forma aleatória, o envio de mensagens para contatos específicos no WhatsApp, a obtenção de resumos sobre diversos assuntos, a realização de pesquisas em plataformas como YouTube, Wikipedia, Google, entre outras funcionalidades... No momento, a LARI é capaz de reconhecer mais de 30 comandos por voz!";
                // Adicionar conteúdo ao carrossel
                var carouselContainer = document.getElementById('project-carousel');
                carouselContainer.innerHTML = '';
                var media = [{
            ...
            if (projectName === 'vstars') {
                title = "V STARS";
                description = "V = 5 | STARS = estrelas | Logo, somos 5 estrelas, V STARS hehe, bom esse é um APP/WEB que criei para a empresa simulada.";
                // Adicionar conteúdo ao carrossel
                var carouselContainer = document.getElementById('project-carousel');
                carouselContainer.innerHTML = '';
                var media = [{
                        type: 'video',
                        src: 'images/VSTARS/preview.mp4'
                    },
                    {
                        type: 'image',
                        src: 'images/VSTARS/1.png'
                    },
                    {
                        type: 'image',
                        src: 'images/VSTARS/2.png'
                    },
                    {
                        type: 'image',
                        src: 'images/VSTARS/3.png'
                    },
                    {
                        type: 'image',
                        src: 'images/VSTARS/4.png'
                    },
                    {
                        type: 'image',
                        src: 'images/VSTARS/5.png'
                    },
                    {
                        type: 'image',
                        src: 'images/VSTARS/6.png'
                    }
                ];
                media.forEach(function(item) {
                    if (item.type === 'image') {
            ...
            if (projectName === 'tpb2') {
                title = "BAÚ DOS PIRATAS";
                description = "Bom pra quem não sabe, o ThePirateBay foi e ainda é um site que seu unico intuito é o compartilhamento de arquivos pirateados, mas por que ele é tão importante? Simples, sem ele muitos jogos, filmes, e semelhantes deixariam de existir da historia, sobrando apenas em lembranças, isso é só um projeto artistico e mesmo que seja complementa funcional, e contenha diversos arquivos piratas, ele não está online e mesmo em operação ele não tem os arquivos no servidor, apenas indexados por um wrapper. è apenas um projeto com intuito nostalgico e artistico";
                // Adicionar conteúdo ao carrossel
                var carouselContainer = document.getElementById('project-carousel');
                carouselContainer.innerHTML = '';
                var media = [{
                        type: 'video',
                        src: 'images/ThePirateBay2/ThePirateBay2.mp4'
                    },
                    {
                        type: 'image',
                        src: 'images/ThePirateBay2/1.png'
                    },
                ];
                media.forEach(function(item) {
                    if (item.type === 'image') {
            ...
            if (projectName === 'limastore') {
                title = "LIMA STORE";
                description = "Como um bom mamifero desprovido de sono, e com curiosas capacidades de converter cafeína em soluções de bugs (Programador), Prefiro evitar o maximo possivel de contato com os queridos usuarios (Irmãos entenderam o porquê), Criei o jorge. Jorge é um inteligencia artificial baseado na LARI, e sua unica função é receber uma descrição dada pelo cliente, e baseado nos parametros em que ele foi treinado, dar um relatorio e precificação que eu normalmente daria, assim todos cliente que quiser meus serviços personalizados, terão uma resposta instatânea em qualquer momento do dia, e em qualquer dia (Ainda bem que IA não tem direito trabalhista)";
                // Adicionar conteúdo ao carrossel
                var carouselContainer = document.getElementById('project-carousel');
                carouselContainer.innerHTML = '';
                var media = [{
                        type: 'image',
                        src: 'images/limastore/1.png'
                    },
                    {
                        type: 'image',
                        src: 'images/limastore/2.png'
                    },
                    {
                        type: 'image',
                        src: 'images/limastore/3.png'
                    },
                    {
                        type: 'image',
                        src: 'images/limastore/4.png'
                    },
                    {
                        type: 'image',
                        src: 'images/limastore/5.png'
                    },
                    {
                        type: 'image',
                        src: 'images/limastore/6.png'
                    }
                ];
                media.forEach(function(item) {
                    if (item.type === 'image') {
            ...
            if (projectName === 'e.a.s.y') {
                title = "E.A.S.Y. (Effortless All-in-One Payment System)";
                description = "é um sistema/painel que por ele, você pode aceitar diversas formas de pagamento, seja ela Centralizada com moedas normais, ou Descentralizadas como crypto e stable coins, mesmo sem sabe programar e dispensando maquininhas";
                // Adicionar conteúdo ao carrossel
                var carouselContainer = document.getElementById('project-carousel');
                carouselContainer.innerHTML = '';
                ...
                var media = [{
                        type: 'image',
                        src: 'images/e.a.s.y/1.png'
                    },
                    {
                        type: 'image',
                        src: 'images/e.a.s.y/2.png'
                    },
                    {
                        type: 'image',
                        src: 'images/e.a.s.y/3.png'
                    },
                    {
                        type: 'image',
                        src: 'images/e.a.s.y/4.png'
                    }
                ];
            ...
            // Definir o título e a descrição no popup
            ...
            // Inicializar o carrossel de imagens e vídeos usando a biblioteca Slick Carousel
            $('.carousel').slick({
